...
public class CommonConstant {
  ...
  public static final String LABEL_KEY_OPERATOR_VERSION = "operator-version";
  ...
  // ==============Data Node ===============
  public static final String DATA_NODE_PROPERTY_FILE_NAME = "iotdb-datanode.properties";
  public static final String DATA_NODE_REST_PROPERTY_FILE_NAME = "iotdb-rest.properties";
  public static final String DATA_NODE_INIT_SCRIPT_FILE_NAME = "datanode-init.sh";
  public static final String DATA_NODE_RPC_ADDRESS = "rpc_address";
  public static final String DATA_NODE_RPC_PORT = "rpc_port";
  public static final String DATA_NODE_MPP_DATA_EXCHANGE_PORT = "mpp_data_exchange_port";
  public static final String DATA_NODE_INTERNAL_ADDRESS = "internal_address";
  public static final String DATA_NODE_INTERNAL_PORT = "internal_port";
  public static final String DATA_NODE_DATA_REGION_CONSENSUS_PORT = "data_region_consensus_port";
  public static final String DATA_NODE_SCHEMA_REGION_CONSENSUS_PORT =
      "schema_region_consensus_port";
  public static final String DATA_NODE_TARGET_CONFIG_NODE = "target_config_nodes";

  public static final String DATA_NODE_MODE_STANDALONE = "standalone";
  public static final String DATA_NODE_MODE_CLUSTER = "cluster";

  // ========== Metrics ==============
  public static final String METRIC_CONFIG_FILE_NAME = "iotdb-metric.yaml";
  public static final String METRICS_PORT = "prometheusExporterPort";
}
